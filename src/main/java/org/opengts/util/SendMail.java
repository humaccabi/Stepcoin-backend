    ...
    **/
    ...
    public static class SmtpProperties
    {
        ...
        public String getBccEmail() {
            ...
            return StringTools.trim(V); // may be blank (actually likely blank)
        }
        // ----
        public boolean equals(Object other) {
            ...
            // -- BCC email
            if (!this.getBccEmail().equals(sp.getBccEmail())) {
                //Print.logInfo("SmtpProperties.equals: SMTP BCC differs");
                return false;
            }
            // -- equals
            return true;
